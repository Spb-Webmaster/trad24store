                            ...
                            <div class="cabinet_radius12_fff">
                                ...
                                @if(count($items))
                                    <div class="c__title_subtitle">
                                        <h3 class="F_h1">{{ __('Документы') }}</h3>
                                        <div class="F_h2 pad_t5"><span>{{ __('Документы от администрации портала') }}</span>
                                        </div>
                                    </div>
                                    <div class="user_page">
                                        ...
                                        <div class="m_items">
                                            @foreach($items as $item)
                                                <a href="{{ route('m_user_doc', ['id' => $item->id]) }}" class="a_temp">
                                ...
                                @else
                                    <div class="c__title_subtitle">
                                        <h3 class="F_h1">Документы</h3>
                                        <div class="F_h2 pad_t5"><span>Для вас нет открытых документов</span></div>
                                    </div>
                                @endif
