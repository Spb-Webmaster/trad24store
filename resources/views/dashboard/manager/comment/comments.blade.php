                        ...
                        <div class="cabinet__right">
                            ...
                            <div class="cabinet_radius12_fff">
                                ...
                                <div class="c__title_subtitle">
                                    <h3 class="F_h1">{{ __('Комментарии (Отзывы)') }}</h3>
                                    <div class="F_h2 pad_t5">
                                        <span>{{__('Отзывы  сданные на проверку от любых пользователей сайта')}}</span>
                                    </div>
                                </div>
                                    ...
                                    @if(count($items))
                                        ...
                                        <div class="dashboardBox__a_users a_users pad_b26">
                                            ...
                                            @foreach($items as $k=>$item)
                                                ...
                                                <div class="a_user__row a_user  background_green ">
                                                    ...
                                                    <a href="{{ route('m_comment', ['id' => $item->id]) }}"
                                                       class="a_user__personal">

                                                            <div class="color_grey_14">Проверить</div>
