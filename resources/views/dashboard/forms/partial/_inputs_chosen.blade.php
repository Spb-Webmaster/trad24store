        ...
        <div class="text_input">
            ...
            <div class="selectClass _sex">
                <select class="js-chosen" data-placeholder="Выбрать пол"   name="sex" id="registerSex">
                        ...
                        <option value="Мужчина" @if($user->sex == 'Мужчина') {{ 'selected' }}@endif>Мужчина</option>
                        <option value="Женщина" @if($user->sex == 'Женщина') {{ 'selected' }}@endif>Женщина</option>
        ...
        <div class="text_input">
            ...
            <div class="selectClass _status">
                <select class="js-chosen" data-placeholder="Выбрать статус"   name="status" id="registerStatus">
                    ...
                    <option value="1" @if($user->status == 1) {{ 'selected' }} @endif>Действующий</option>
                    <option value="0" @if($user->status == 0) {{ 'selected' }} @endif>Приостановлен</option>
        ...
        <div class="c__flex_100">
            <div class="text_input">
                ...
                <div class="selectClass _language">
                    <select class="js-chosen" data-placeholder="Выбрать язык" multiple  name="language[]" id="registerLanguage">
