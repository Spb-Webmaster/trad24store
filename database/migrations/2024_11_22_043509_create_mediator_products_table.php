...
return new class extends Migration
{
    ...
    {
        Schema::create('mediator_products', function (Blueprint $table) {
            $table->id();
            $table->string('title');
            ...
            $table->string('published_menu')->default(1);
            $table->string('title_menu')->nullable();
            $table->foreignIdFor(\App\Models\MediatorCategory::class)
                ->nullable()
                ->constrained()
                ->cascadeOnDelete();
    ...
    {
        Schema::dropIfExists('mediator_products');
    }
};
