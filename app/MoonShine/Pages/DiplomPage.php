...
class DiplomPage extends Page
{
    ...
    public function setting()
    {
        ...
        if (Storage::disk('config')->exists('moonshine/diplom.php')) {
            $result = include(storage_path('app/public/config/moonshine/diplom.php'));
        } else {
            $result = null;
        }
    ...
    public function components(): array
    {
        ...
        return [
            ...
            FormBuilder::make('/moonshine/diplom', 'POST')
                ->fields([
