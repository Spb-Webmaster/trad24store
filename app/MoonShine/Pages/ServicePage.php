...
class ServicePage extends Page
{
    ...
    public function setting()
    {
        ...
        if (Storage::disk('config')->exists('moonshine/service.php')) {
            $result = include(storage_path('app/public/config/moonshine/service.php'));
        } else {
            $result = null;
        }
    ...
    public function components(): array
    {
        ...
        return [
            ...
            FormBuilder::make('/moonshine/service', 'POST')
                ->fields([
